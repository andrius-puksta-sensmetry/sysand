...
/// 1. Do not resolve any further if file_resolver is successful, or did not find the project,
///    or rejected it (so it is a path, and it would not make sense trying to resolve it via
///    any other resolvers), otherwise go to step 2.
